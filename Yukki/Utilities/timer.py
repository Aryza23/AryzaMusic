        ...
        if 0 < user_input_time <= 7:
            while user_input_time:
                ...
                if db_mem[chat_id]["videoid"] != videoid:
                    break
                if await is_music_playing(chat_id) and datetime.now() > left_time.get(
                    videoid
                ):
                    s = user_input_time % 60
                    c_t = "00:{:02d}".format(s)
                    if aud == 0:
                        buttons = timer_markup(videoid, user_id, c_t, duration_min)
                    else:
                    ...
                    try:
                        ...
                        user_input_time -= e.x
                    left_time[videoid] = datetime.now() + timedelta(milliseconds=550)
            ...
            while user_input_time > 0:
                ...
                if await is_music_playing(chat_id) and datetime.now() > left_time.get(
                    ...
                    try:
                        ...
                        await asyncio.sleep(e.x)
                        user_input_time -= e.x
                    left_time[videoid] = datetime.now() + timedelta(milliseconds=3500)
            ...
            while user_input_time > 0:
                ...
                if await is_music_playing(chat_id) and datetime.now() > left_time.get(
                    ...
                    try:
                        ...
                        await asyncio.sleep(e.x)
                        user_input_time -= e.x
                    left_time[videoid] = datetime.now() + timedelta(milliseconds=5300)
            ...
            while user_input_time > 0:
                ...
                if await is_music_playing(chat_id) and datetime.now() > left_time.get(
                    ...
                    try:
                        ...
                        await asyncio.sleep(e.x)
                        user_input_time -= e.x
                    left_time[videoid] = datetime.now() + timedelta(milliseconds=9100)
        else:
            return
